    ...
    try {
        ...
        bcrypt.compare(password, user.password, (err, matched) => {
            if (matched) {
                ...
                res.cookie('token', token, {httpOnly: true, expires: expirationTime, sameSite: "strict", secure: true});
                res.cookie('user_id', user.id, {httpOnly: true, expires: expirationTime, sameSite: "strict", secure: true});
                res.cookie('username', `${user.firstName} ${user.lastName}`, {httpOnly: true, expires: expirationTime, sameSite: "strict", secure: true});
                res.cookie('avatar', user.avatar, {httpOnly: true, expires: expirationTime, sameSite: "strict", secure: true});
